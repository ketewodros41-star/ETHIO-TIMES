"""Alembic environment for ETHIOTIMES.

The connection URL comes from application settings (env-driven). We prefer the
direct migration URL when configured, since some Supabase pooler modes do not
support the DDL/locks used by migrations.
"""
